...
namespace BDO_Utility_Application.Controllers
{
    public class NodesController : Controller
    {
        ...
        {
            ViewBag.territories = db.Territories.ToList();
            ViewBag.types = new SelectList(db.NodeTypes, "Name", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "NodeID,Name,Area")] Node node)
        {
